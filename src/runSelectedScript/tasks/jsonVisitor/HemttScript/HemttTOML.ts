...
import { Folder } from "./HemttJSON\Folder";
import { HemttScript } from "..\HemttScript";

const packageName = "hemtt.toml";

export class HemttTOML extends TreeItem {
  ...
  constructor(folder: Folder, relativePath: string) {
    super(
      HemttTOML.getLabel(folder.label!, relativePath),
      TreeItemCollapsibleState.Expanded
    );
    this.folder = folder;
    this.path = relativePath;
    this.contextValue = "packageTOML";
